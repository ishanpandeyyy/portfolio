            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <motion.div className="flex items-center text-sm text-white/80 font-medium">
                    <Calendar className="w-4 h-4 mr-1" />
                    {cert.date}
                  </motion.div>
                </div>

                <h3 className="text-xl font-bold mb-2 text-white group-hover:text-blue-600 transition-colors duration-300">
                  {cert.title}
                </h3>
                ...
                <p className="text-white/80 mb-4 text-sm leading-relaxed">{cert.description}</p>

                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-white mb-2">Course Content:</h4>
                ...
                {cert.credits && <p className="text-sm text-white/80 mb-2">Credits: {cert.credits}</p>}

                {cert.rollNo && <p className="text-sm text-white/80 mb-4">Roll No: {cert.rollNo}</p>}
